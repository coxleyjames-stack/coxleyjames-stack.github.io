...
On May 20th the first of Devman's mistakes were made public by Rakesh Krishnan, exposing the public IP address associated with his .onion site:
...
This is not the first time Devman's private RaaS communications have been compromised. Thanks to XYZ, we were given additional private communications from a previous chat.  These chat gave insight into how devman operates and orders his affiliates around. Additionally, we saw massive overlap in usernames across both sets of breached communications.
...
On October 15th, Devman tries to “organise” affiliates by demanding everyone list their working hours.
...
On October 18th, Devman proclaims that he is "a machine" in response to a ransomware victim communicating that the link nor email address did not work. Feel like a machine now lil bro? 
...
Also on October 18th, desperate for victims, Devman encouraged one of his closer associates, `blackwall` to attack what they suspected to be a Israeli honeypot.   
